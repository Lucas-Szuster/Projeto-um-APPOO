...
usuario_um.adicionar_evento(Evento('evento 1', datetime(1, 1, 1, 1, 1), 10))
usuario_um.adicionar_evento(Evento('evento 2', datetime(2, 2, 2, 2, 2), 10))
...
ger.adicionar_evento_em_area('area 1', Evento('evento 1', datetime(1, 1, 1, 1, 1), 10))
ger.adicionar_evento_em_area('area 1', Evento('evento 2', datetime(2, 2, 2, 2, 2), 10))
